...
Now let's understand the below question more clearly.



Here we are calling the component Button thrice with each time has the different values to the propsclassName and buttonText .


Hence in the component Button, the expression button ${className} using template Literals will result in the string that includes the corresponding value of prop className .
